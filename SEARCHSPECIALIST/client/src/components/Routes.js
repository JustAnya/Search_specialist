...
import Home from "./Matching&Home&Landing/Home";
  ...
  return (
    <Router>
      ...
      <Container>
        ...
        <Route path="/company-profile" exact component={protect(CompanyProfile, "company")} />
        <Route path="/company-profile/:id" component={protect(CompanyProfile)} />
        <Route path="/login" component={Login} />
        <Route path="/applicant-profile" exact component={protect(ApplicantProfile, "applicant")} />
        <Route path="/applicant-profile/:id" component={protect(ApplicantProfile)} />
        <Route path="/create-opportunity" component={protect(NewOpportunityForm, "company")} />
        ...
        <Route path="/admin-Profiles" component={protect(AdminProfiles, "moderator")} />
