        ...
        <Grid.Row>
          <Grid.Column>
            <Header as="h1" fontSize="30" color="blue" textAlign="center">
              <strong>Search Specialist</strong> <br></br> IT field{" "}
            </Header>
          </Grid.Column>
        </Grid.Row>
        <Grid.Row>
        ...
        <Grid.Row>
          <Grid.Column>
            <Header color="blue" textAlign="center">
             <em>Search specialist</em> this is a site that will help you find the perfect employee and dream job in IT-field
            </Header>
          </Grid.Column>
        </Grid.Row>
        <Grid.Row
